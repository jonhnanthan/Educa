...
//                        MainActivity.teacherDataBaseHelper.addExercise(exercise);
                        ...
                        DataBaseProfessor.getInstance(MultipleCorrectChoiceExerciseStep3Activity.this).addActivity(name, DataBaseProfessor.getInstance(getApplicationContext()).MULTIPLE_CHOICE_EXERCISE_TYPECODE, exercise.getJsonTextObject());

                        // ExerciseStorage.getListExercise().add(exercise);
                        Intent intent = new Intent(MultipleCorrectChoiceExerciseStep3Activity.this, TeacherHomeActivity.class);
