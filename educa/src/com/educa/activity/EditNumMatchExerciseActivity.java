...
public class EditNumMatchExerciseActivity extends Activity {
    ...
    private NumMatchExercise numMatchExercise;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_num_match_exercise);
        Intent i = getIntent();
        exercise = i.getCharSequenceArrayListExtra("EditNumMatchExercise");

        image = exercise.get(1).toString();
        color_layout = (LinearLayout) findViewById(R.id.layout_image);
        color_layout.setBackgroundResource(Integer.parseInt(image));
        color_layout.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                NumPickerDialog dialog = new NumPickerDialog(
                        EditNumMatchExerciseActivity.this);
            ...
            public void onClick(View v) {
                if (checkValidation() && !checkDuplication()) {
                    ...
                    if (id != -1) {
                        ...
                        String type = DataBaseProfessor.getInstance(getApplicationContext()).NUM_MATCH_EXERCISE_TYPECODE;
                        ...
                        for (String string : exercises) {
                            if (string.equals(numMatchExercise.getJsonTextObject())) {
                                ...
                                try {
                                    ...
                                    newExercise = new NumMatchExercise(
                                            json.getString("name"),
                                            json.getString("type"),
                                            json.getString("date"),
                                ...
                                editAlert(newExercise, numMatchExercise, rightAnswer);
                            }
                        }
                    } else {
                        Toast.makeText(
    ...
    public void editAlert(final NumMatchExercise numMatchExercise, final NumMatchExercise exerciseOnStorage, final String rightAnswer) {
        ...
        builder.setPositiveButton(getResources().getString(R.string.ok),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        numMatchExercise.setQuestion(question.getText().toString());
                        numMatchExercise.setAlternative1(answer1.getText().toString());
                        numMatchExercise.setAlternative2(answer2.getText().toString());
                        numMatchExercise.setAlternative3(answer3.getText().toString());
                        numMatchExercise.setAlternative4(answer4.getText().toString());
                        numMatchExercise.setColor(image);
                        numMatchExercise.setStatus(String.valueOf(Status.NEW));
                        numMatchExercise.setCorrection(String.valueOf(Correction.NOT_RATED));
    ...
    public static void setImage(Integer imagecode) {
        color_layout.setBackgroundResource(imagecode);
    }
}
