        ...
        builder.setPositiveButton(getResources().getString(R.string.ok),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        DataBaseProfessor.getInstance(getApplicationContext()).addActivity(colorMatchExercise.getName(), DataBaseProfessor.getInstance(getApplicationContext()).IMAGE_MATCH_EXERCISE_TYPECODE, colorMatchExercise.getJsonTextObject());
                        
                        Intent intent = new Intent(EditImageMatchExerciseActivity.this, TeacherHomeActivity.class);
