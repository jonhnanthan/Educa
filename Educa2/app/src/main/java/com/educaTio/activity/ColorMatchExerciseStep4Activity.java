...
//                        MainActivity.teacherDataBaseHelper.addExercise(exercise);
                        ...
                        DataBaseProfessor.getInstance(getApplicationContext()).addActivity(ActiveSession.getActiveLogin(), spinner.getSelectedItem().toString(), name, DataBaseProfessor.getInstance(getApplicationContext()).COLOR_MATCH_EXERCISE_TYPECODE, exercise.getJsonTextObject());
