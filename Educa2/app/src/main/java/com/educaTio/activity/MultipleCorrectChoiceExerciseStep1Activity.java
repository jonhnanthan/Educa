...
public class MultipleCorrectChoiceExerciseStep1Activity extends Activity {
            ...
            public void onClick(View v) {
                if (checkValidation()) {
                    ...
                    Intent confirmAnswersIntent = new Intent(
                            MultipleCorrectChoiceExerciseStep1Activity.this,
                            MultipleCorrectChoiceExerciseStep2Activity.class);
