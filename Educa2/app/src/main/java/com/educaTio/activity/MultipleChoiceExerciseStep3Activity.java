...
//                        MainActivity.teacherDataBaseHelper.addExercise(exercise);
                        ...
                        DataBaseProfessor.getInstance(MultipleChoiceExerciseStep3Activity.this).addActivity(ActiveSession.getActiveLogin(), spinner.getSelectedItem().toString(), name, DataBaseProfessor.getInstance(getApplicationContext()).MULTIPLE_CHOICE_EXERCISE_TYPECODE, exercise.getJsonTextObject());
